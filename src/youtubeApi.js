...
var giveMeRandomVid = () => {
    ...
    $.get(youtubeApi)
        .then(results => {
            ...
            targetDiv.attr('src', `https://www.youtube.com/embed/${video}?enablejsapi=1&amp;origin=http%3A%2F%2F127.0.0.1%3A5500&amp;widgetid=1`)
            targetDiv.css('display', 'block');
            $('#entertainMeBtn').removeClass('disabled');
            targetDiv.css('opacity', '1');
            targetDiv.css('animation', 'videoOn 1s ease-in')
        })
